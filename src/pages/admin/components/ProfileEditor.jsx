...
export default function ProfileEditor() {
  ...
  return (
    <div className="space-y-10">
      ...
      <div className="glass p-5 md:p-8 border border-red-500/20 relative space-y-10">
        ...
        <section>
          ...
          <div className="mb-8">
            <div className="flex flex-col md:flex-row items-center md:items-start gap-8">
              <div className="w-28 h-28 bg-bg-surface border border-red-500/30 overflow-hidden flex-shrink-0 group relative mx-auto md:mx-0">
                {profile.photo ? (
            ...
            {(profile.heroPhrases || []).length > 0 ? (
              (profile.heroPhrases || []).map((phrase, idx) => (
                <div key={idx} className="flex gap-3 group">
                  <div className="font-mono text-[10px] text-red-500/40 w-6 text-right pt-3 flex-shrink-0">{idx + 1}</div>
                  <input
                    type="text"
                    value={phrase}
