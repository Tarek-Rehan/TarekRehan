    ...
    <div className="space-y-8">
      ...
      <div className="space-y-8">
        {experience.map((item, idx) => (
          <div key={item.id || idx} className="glass p-6 border border-red-500/20 relative">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-4">
              <div>
                <label className="block font-mono text-xs text-red-500/70 uppercase tracking-widest mb-2">Role / Title</label>
                <input
              ...
              <div>
                <label className="block font-mono text-xs text-red-500/70 uppercase tracking-widest mb-2">Organization</label>
                <input
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-4">
              <div>
                <label className="block font-mono text-xs text-red-500/70 uppercase tracking-widest mb-2">Location</label>
                <input
              ...
              <div>
                <label className="block font-mono text-xs text-red-500/70 uppercase tracking-widest mb-2">Start Date</label>
                <input
              ...
              <div>
                <label className="block font-mono text-xs text-red-500/70 uppercase tracking-widest mb-2">End Date</label>
                <input
